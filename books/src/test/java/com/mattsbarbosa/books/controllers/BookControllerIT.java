...
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_EACH_TEST_METHOD) //limpa o database antes dos testes
public class BookControllerIT {
    ...
    public void testThatHttp204IsReturnedWhenBookDoesntExist() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/books/12546"))
